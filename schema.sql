...
-- add columns from salaries into emp_info
SELECT e.emp_no,
	e.first_name,
	e.last_name,
	e.gender,
...
;
--DROP dept_no
ALTER TABLE emp_info_sales
DROP COLUMN dept_no;


-- Tailored list for dev and sales team
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	de.dept_no,
...
;
--DROP dept_no
ALTER TABLE emp_info_sales_dev
DROP COLUMN dept_no;

SELECT * FROM emp_info_sales_dev